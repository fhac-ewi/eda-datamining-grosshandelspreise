...
\begin{titlepage}
  ...
  \noindent\makebox[\textwidth][c]{
    \begin{minipage}{0.6\textwidth}
      ...
      \section*{Vorwort}
      Begleitend zu dieser Seminararbeit gibt es ein Matlab Skript, welches alle der hier vorgestellten Analysen und Modellierungen enthält. Die verwendeten Rohdaten sowie Cache-Files und Optimierungsergebnisse liegen ebenfalls dieser Arbeit bei.
